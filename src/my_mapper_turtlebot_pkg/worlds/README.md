...
2. `ros2 launch nav2_bringup bringup_launch.py use_sim_time:=True map:=/home/penguin/robot_ws/src/my_mapper_turtlebot_pkg/maps/stress_maze_map.yaml`
3. `ros2 launch my_mapper_turtlebot_pkg mapper_explorer.launch.py`
